...
import { LayoutDashboard, BarChart2, ScrollText, CalendarDays, Globe, User, Clock, LogOut, ChevronDown, Shield, TrendingUp, BookOpen, Sun, Moon, Target, Layers, Plus, Check, X } from "lucide-react";
...
export function Topbar() {
  ...
  return (
    <header className="flex items-center justify-between px-4 py-2 border-b border-[#2A2A2A] bg-[#0D0D0D]">
      ...
      {/* Right: space + dark mode + clock + user */}
